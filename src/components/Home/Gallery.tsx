...
const Gallery = ({
  ...
  description = "Cada proyecto representa nuestro compromiso con la calidad, la seguridad y la innovación.Conoce algunas de las obras que reflejan nuestra experiencia en infraestructura, redes y soluciones especializadas.",
  items = data,
}: GalleryProps) => {
